# Adapted for homekit_climate_plus from home-assistant/core.
#
# Source:   homeassistant/components/homekit/util.py
# Upstream: https://github.com/home-assistant/core/blob/1fec38ef28c33ec8fe6e0ec6a33a1ca144b1cc24/homeassistant/components/homekit/util.py
# Commit:   1fec38ef28c33ec8fe6e0ec6a33a1ca144b1cc24 (HA release 2026.4.3)
# License:  Apache License 2.0 — see NOTICE in repo root.
#
# Internal cross-imports to .const / .iidmanager / .models were rewritten to
# import directly from homeassistant.components.homekit.* so we can rely on
# HA's live modules for those small dependencies without vendoring them too.
...
from homeassistant.components.homekit.models import HomeKitConfigEntry
